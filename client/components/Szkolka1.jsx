        ...
        <div className="tile is-ancestor">
            ...
            <div className="tile is-parent is-vertical is-4">
                <article className="tile is-child box has-text-justified">
                    ...
                    <p className="content"><strong>Mamy 30 lat doświadczenia</strong>. </p>
                    <p className="content">Nasza Szkółka została powstała w roku 1986 w Olszowej w województwie wielkopolskim. <br />
                    Przez kolejne lata działalności rozrastała się dzięki inwestycjom w sprzęt, wprowadzeniu nowych roślin oraz poszerzeniu terenu uprawny.</p>
                </article>
                <article className="tile is-child box has-text-justified">
            ...
            <div className="tile is-vertical is-parent is-3">
                <div className="tile is-child box">
